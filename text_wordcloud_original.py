# # Function to create word clouds and analyze word frequencies
# from wordcloud import WordCloud
# from PIL import Image

# # Function to create word clouds
# def create_wordclouds(df, text_columns, mask_path=None, background_color='white', 
...
# def analyze_word_frequencies(df, text_columns, top_n=20, save_plots=False):
#     """
...
#     def plot_frequencies(words_freq, ax, title):
...
#         plot_frequencies(word_freq, axes[idx][0], f'Word Frequencies - {column}')
        
#         # Create percentage plot
#         total_words = sum(freq for _, freq in word_freq)
#         word_freq_pct = [(word, (freq/total_words)*100) for word, freq in word_freq]
#         plot_frequencies(word_freq_pct, axes[idx][1], f'Word Frequencies (%) - {column}')
...
#     plot_frequencies(combined_freq, axes[-1][0], 'Word Frequencies - Combined Text')
...
#     plot_frequencies(combined_freq_pct, axes[-1][1], 'Word Frequencies (%) - Combined Text')
...
#     # Create combined columns word clouds with basic recommended settings
#     # plt.style.use('seaborn')  # Optional: use seaborn style
#     fig = create_wordclouds(
#         preprocessed_df,
#         columns_to_analyze,
...
#     analyze_word_frequencies(preprocessed_df, columns_to_analyze, top_n=20)
    
#     # Optional: Create individual word clouds with custom settings
#     for column in columns_to_analyze:

#         # Setting for white background and viridis colormap
#         wc = WordCloud(
#             background_color='white',
#             max_words=100,
#             width=800,
...
# =======================================================================================================================
# # Display only the word clouds

# # # Basic usage with default settings
# columns_to_analyze = ['title', 'tags', 'description']
# fig = create_wordclouds(preprocessed_df, columns_to_analyze)
# plt.show()
